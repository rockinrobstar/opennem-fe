...
export default {
  ...
  methods: {
    ...
    setupEventSubscribers() {
      ...
      EventBus.$on('chart.zoom.startEnd', () => {
    ...
    clearEvents() {
      ...
      EventBus.$off('chart.zoom.startEnd');
    ...
    updateChart() {
      ...
      this.chart.panels[0].stockGraphs.push(getDemandGraph());
    ...
    getPanelListeners() {
      return [
        ...
        { event: 'clickGraphItem', method: this.onGraphItemClicked },
      ];
    },
    ...
    onGraphItemClicked(e) {
      const rawData = e.item.dataContext.rawData;
      const rDLength = rawData.length;
      const startDate = rawData[0].date;
      const endDate = rawData[rDLength - 1].date;
